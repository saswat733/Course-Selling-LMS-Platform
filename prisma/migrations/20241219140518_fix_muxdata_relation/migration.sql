...
-- CreateIndex
CREATE INDEX "Course_categoryIds_idx" ON "Course"("categoryIds");
...
-- AddForeignKey
ALTER TABLE "Course" ADD CONSTRAINT "Course_categoryIds_fkey" FOREIGN KEY ("categoryIds") REFERENCES "Category"("id") ON DELETE SET NULL ON UPDATE CASCADE;
